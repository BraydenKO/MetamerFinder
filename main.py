...
This script allows users to load a target image and a neural network model,
and then optimize a noise image until its internal activations at specified
layers match those of the target image.
"""
...
def main():
    ...
    # 2. Load Model
    # Check in models/ folder if model_id is a filename
    model_id = args.model
    ...
    try:
        if is_vision:
            ...
            # Standard input size for most ImageNet models is 224x224
